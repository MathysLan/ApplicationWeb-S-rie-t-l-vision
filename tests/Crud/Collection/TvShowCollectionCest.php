...
class TvShowCollectionCest
{
    ...
    {
        $expectedTvShows = [
            ['id' => 3, 'name' => 'Friends', 'originalName' => 'Friends', 'homepage' => 'https://www.netflix.com/title/70153404',
                ...
                'posterId' => 15],
            ['id' => 25, 'name' => 'Futurama', 'originalName' => 'Futurama', 'homepage' => 'http://www.comedycentral.com/shows/futurama',
                ...
                'posterId' => 231],
            ['id' => 57, 'name' => 'Good Omens', 'originalName' => 'Good Omens', 'homepage' => 'https://www.amazon.com/dp/B07FMHTRFF',
                ...
                'posterId' => 466],
            ['id' => 70, 'name' => 'Hunters', 'originalName' => 'Hunters', 'homepage' => 'https://www.amazon.com/dp/B07ZPGMH1B',
                ...
                'posterId' => 536],
            ['id' => 40, 'name' => "La caravane de l'étrange", 'originalName' => 'Carnivàle', 'homepage' => 'http://hbo.com/carnivale/',
    ...
    public function findByGenreId(CrudTester $I)
    {
        ...
        $tvShows = TvshowCollection::findByGenreId(3);
        $I->assertCount(count($expectedTvShows), $tvShows);
        $I->assertContainsOnlyInstancesOf(TvShow::class, $tvShows);
        foreach ($tvShows as $index => $tvShow) {
            $expectedTvShow = $expectedTvShows[$index];
